package com.cihon.androidrestart_keven.PopupWindow;
...
public class CommonPoupWindow extends PopupWindow {
    ...
    public CommonPoupWindow(Context context) {
    ...
    public static class Builder {
        ...
        public CommonPoupWindow create() {
            final CommonPoupWindow popupWindow = new CommonPoupWindow(params.mContext);
